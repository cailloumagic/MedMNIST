...
patience = 10
sev = 1
nb_images = 6  # Number of images to calculate heatmap
...
class ImageProcessor:
    ...
    def setup_paths(self, k, data_flag, directory_name_0, directory_name_1, label_class, label_class_name, sev, augmented, bool):
        ...
        if platform.system() == 'Windows':
            ...
            csv_rmses_all_path = rf'C:\Users\pierr\Desktop\Cours\BME4\Coding\Outputs\{data_flag}\{directory_name_0}\{directory_name_3}\{data_flag}_{label_class}_{label_class_name}_{data_nb}^{data_nb_tot}_images{augmented}{bool}_rmses_all'
            ...
            csv_rmses_all_path = rf'/home/ptreyer/Outputs/{data_flag}/{directory_name_0}/{directory_name_3}/{data_flag}_{label_class}_{label_class_name}_{data_nb}^{data_nb_tot}_images{augmented}{bool}_rmses_all'
...
for label_class in label_classes:
    ...
    if not correct_false_predictions:
        break
    ...
    for k in range(data_nb):  # data_nb = nb_images, data points
        ...
        correct_false_predictions.remove(desired_image_index)
